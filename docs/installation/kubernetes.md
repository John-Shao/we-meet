...
| AWS_STORAGE_BUCKET_NAME_VIDEO                   | Video/recording S3 bucket name                                                                                                                                 | meet-media-storage                                                                                                                                            |
| AWS_STORAGE_BUCKET_NAME_TASK_ATTACHMENT         | Private S3 bucket for task attachments                                                                                                                       | we-task-attachment                                                                                                                                            |
...
| MEETING_SESSION_STALE_AFTER_SECONDS             | Age after which an active meeting session is checked against LiveKit and reconciled if its terminal webhook was lost                                                                                                      | 86400                                                                                                                                                         |
