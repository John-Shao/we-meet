...
# 先 dry-run 看会改哪些文件
bash deploy/aliyun/setup-customer.sh --dry-run your-domain.com ops@your-domain.com
...
docker login --username='<MYORG2025@xxxx>' your-cr.cr-domain.com
...
# values.meet.yaml 里 image repo 已经写死为 your-cr.cr-domain.com/we-meet/*
sudo -E env KUBECONFIG=/etc/rancher/k3s/k3s.yaml \
