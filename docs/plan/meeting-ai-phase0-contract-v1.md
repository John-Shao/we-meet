...
阶段 1 第六批实现差异见 [第六批执行记录](meeting-ai-phase1-batches-2026-09-12-13.md#phase1-batch6)：独立创建暂由 POST /api/v1.0/capture-sessions/ 原子创建记录与采集；原文读使用 original-segments，保留旧 transcripts 响应；音频分片、编辑修订、事件流和完整性验证尚待实现。以下仍是目标契约，不代表全部已上线。
