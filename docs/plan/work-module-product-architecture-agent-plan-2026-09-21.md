...
日期：2026-09-21 · 更新：2026-09-23 · 修订：v1.13，材料生产启用与千问模型候选 · 状态：backend `c6d61ad7e` / Helm revision 402 已启用材料，四种格式生产上传 / 解析通过；沟通生成关闭，真实模型 / 桌面办公验收待完成；D0 剩余发布验收独立跟踪 · 原源码核查基线：we-meet `4c5ca713f`；办公第二批实施基线：`09a7841f9`
