...
日期：2026-09-21 · 更新：2026-09-24 · 修订：v1.19，v2 已部署与语义复验，v3 候选先评测 · 状态：Web / 桌面办公闭环及账本 / 清理回执已通过；backend `2f2d1a443` / Helm revision 418 的 v2 完整 20 条结构通过，语义审阅 15 条通过 / 5 条需修正；v3 候选待评测，P0-1 未整体放行；D0 剩余发布验收独立跟踪 · 原源码核查基线：we-meet `4c5ca713f`；办公第二批实施基线：`09a7841f9`
