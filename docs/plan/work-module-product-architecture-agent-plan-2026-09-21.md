...
日期：2026-09-21 · 更新：2026-09-24 · 修订：v1.24，v5 候选审阅与 v6 待评测 · 状态：Web / 桌面办公闭环及账本 / 清理回执已通过；生产仍为 backend `30cab9491` / Helm revision 419 的 v3；v5 候选完整 20 条契约通过、语义 18 条通过 / 2 条需修正，不发布；v6 候选待真实评测，P0-1 未整体放行；D0 剩余发布验收独立跟踪 · 原源码核查基线：we-meet `4c5ca713f`；办公第二批实施基线：`09a7841f9`
