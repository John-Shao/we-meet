...
日期：2026-09-21 · 更新：2026-09-24 · 修订：v1.22，S20 省略引文定位与 v4 候选 · 状态：Web / 桌面办公闭环及账本 / 清理回执已通过；backend `30cab9491` / Helm revision 419 的 v3 已部署，完整轮次 19/20 契约通过、语义 15 条通过 / 4 条需修正 / S20 原输出未知；独立 S20 诊断再次失败，定位为模型自行插入省略号；v4 候选待真实评测，P0-1 未整体放行；D0 剩余发布验收独立跟踪 · 原源码核查基线：we-meet `4c5ca713f`；办公第二批实施基线：`09a7841f9`
