...
状态：M1 场次投影、M2 产物双写、M3 纪要闭环切换已实施，M4-M5 待实施
...
| M3 纪要闭环切换 ✅ | Summary/ActionItem/Chapter/Chunk/IM/Docs 按 session | 2026-08-17 已实施；同 Room 多场纪要产物隔离，旧 Room API 暂取最近场次兼容 |
