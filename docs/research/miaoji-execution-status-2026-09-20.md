...
> 最新批次：[第 54 批上传全文翻译](miaoji-batch-54-upload-translation.md)：后端、Web、Android 实现和所列本地验证完成；生产待发布。线上统一录像待 Egress/ECS 条件，原生分人/热词仍待办。
...
[第五十三批](miaoji-batch-53-purge-final-acceptance.md) 为当前状态：第 50 批上传等待、第 51 批 ASR 阻塞、第 52 批发布复测已闭环。原生 6 段/AI 1 版/人工 2 版/导出 1 份后删除，源站三个 WAV 404，独立 Docs 正文保留且权限不变；未覆盖场景单独保留。下方各批“待构建/部署/回传”等为历史。
