...
> 最新批次：[第 57 批跨记录召回](miaoji-batch-57-cross-record-retrieval.md)：正文优先、每记录配额、命中窗口和英文抽词；同一题库完整证据 15/25→21/25，逐题无退化，95 项通过。仅 backend 变更，生产待发布/验收；仍有四道语义题，真实回答和大库性能未验收。
...
| 57 | 正文相关性、记录配额、命中窗口、英文抽词；证据覆盖 21/25，95 项回归 | 仅 backend，待发布/验收 | 无改动 |
