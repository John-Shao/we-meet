...
> 最新批次：[第59批证据补位](miaoji-batch-59-evidence-diversity.md)：混合来源12题，完整证据8/9→9/9、应为空1/3→3/3；原31题无退化。重复证据延后、候选/引用配额分离、旧BM25内容词检索；中文原问题回归通过。仅backend需发布，生产重问及App验收待完成。
...
| 59 | 重复证据补位、旧会议字面查询修正、混合来源评测与中文直接回归 | 仅backend，待发布/生产复问 | 无改动 |
