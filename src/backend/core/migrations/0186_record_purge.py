# Generated by Django 5.2.14 on 2026-09-20 15:35
...
class Migration(migrations.Migration):
    dependencies = [
        ("core", "0185_record_lifecycle"),
    ]

    operations = [
        migrations.CreateModel(
            name="MeetingRecordPurge",
            fields=[
                (
                    "id",
                    models.UUIDField(
                ...
                ("upload_key", models.UUIDField(blank=True, null=True, unique=True)),
                (
                    "state",
                    models.CharField(
                        choices=[
