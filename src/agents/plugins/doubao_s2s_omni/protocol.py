"""Volcengine S2S Realtime binary WebSocket protocol.

Implements the 4-byte header + optional fields + payload encoding used by
the 豆包端到端实时语音大模型 API (wss://openspeech.bytedance.com/api/v3/realtime/dialogue).
"""
