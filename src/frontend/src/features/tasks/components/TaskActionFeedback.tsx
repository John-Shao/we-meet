...
const toastCss = css({
  ...
  '&[data-intent="error"]': { borderColor: 'status.danger' },
  '&[data-intent="loading"]': { borderColor: 'border.focus' },
})
const toastIconCss = css({
  display: 'grid',
  placeItems: 'center',
  color: 'status.success',
  '[data-intent="error"] &': { color: 'status.danger' },
  '[data-intent="loading"] &': { color: 'text.link' },
})
