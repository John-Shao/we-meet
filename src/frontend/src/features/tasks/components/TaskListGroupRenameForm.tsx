...
import { useUpdateTaskListGroup } from '../api/fetchTasks'

export const TaskListGroupRenameForm = ({
  group,
  inputRef,
  onCancel,
  onRenamed,
  ...
  const mutation = useUpdateTaskListGroup()
